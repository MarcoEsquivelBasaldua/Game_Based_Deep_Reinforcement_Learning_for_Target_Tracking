'''
Code name: pursuit-evasion_discrete_domain_default_evader.py
Author: Marco Antonio Esquivel Basaldua

Description:
Simulates the Tracking Problem by placing both players in the environment with a predifined evader behaiviour (as set in evader_actions.py).
...
while running:
    ...
    if place_pursuer:
        ...
        if escape_lenght == np.inf:
            # Evader mouvement
            print(evader.pos)
            a_e = evader_actions[tuple(evader.pos)]
            evader.pos = evader_step(a_e)
